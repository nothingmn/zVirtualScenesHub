...
using CommandsResponse = zVirtualClient.Interfaces.CommandsResponse;
using DeviceCommandResponse = zVirtualClient.Interfaces.DeviceCommandResponse;
using GroupDetailsResponse = zVirtualClient.Interfaces.GroupDetailsResponse;
using GroupsResponse = zVirtualClient.Interfaces.GroupsResponse;
using LoginResponse = zVirtualClient.Interfaces.LoginResponse;
using SceneNameChangeResponse = zVirtualClient.Interfaces.SceneNameChangeResponse;
using SceneResponse = zVirtualClient.Interfaces.SceneResponse;
...
namespace zVirtualClient
{
    public class Client : IServiceController
    {
        ...
        public static List<Models.Scene> ScenesList = new List<Scene>(); 
        public static List<Models.Device> DeviceList = new List<Device>();
        ...
        {
            if (DevicesResponse.success) Client.DeviceList = new List<Device>(DevicesResponse.devices);
        ...
        {
            if (SceneResponse.success) Client.ScenesList = new List<Scene>(SceneResponse.scenes);
        ...
        {
            var scene = (from s in Client.ScenesList where s.name == name select s).FirstOrDefault();
            if(scene!=null) StartScene(scene.id);
        }
